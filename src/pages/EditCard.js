...
function Home(props) {
  const { pageSection, language, section, id } = useParams();
    ...
    http
      ...
      .then((result) => {
        if (result.data?.length) {
          ...
          setIsInsert(true);
          setSelectedType(left_content?.selectedType);
          setIsDouble(left_content?.isDouble);
          setIsOnForm(true);
          setOnFormType("options");
          setLeftColumnLength(left_content?.leftColumnLength);
          setRightColumnLength(left_content?.rightColumnLength);
          setLeftElementList(left_content?.leftElementList);
          setContentSelectedType(right_content);
      ...
      <Grid container justifyContent="center">
        ...
        <Grid item xs={collapseFullscreen ? 11.5 : 9.5} position="relative">
          ...
          >
              ...
              >
                {[...new Array(leftColumnLength)].map((item, key) => {
                  ...
                  if (
                    ...
                    // TEXT PROPS
                    const txt_compType =
                      contentSelectedType?.[`1_text_${contentPosition}_${next}`]
                        ?.content?.type;
                    const txt_children =
                      contentSelectedType?.[`1_text_${contentPosition}_${next}`]
                        ?.content?.props?.children;
                    ...
                    // LINK PROPS
                    const link_children =
                      contentSelectedType?.[`1_link_${contentPosition}_${next}`]
                        ?.content?.props?.children?.props?.children;
                    const link_style =
                      contentSelectedType?.[`1_link_${contentPosition}_${next}`]
                    ...
                    const link_href =
                      contentSelectedType?.[`1_link_${contentPosition}_${next}`]
                        ?.content?.props?.children?.props?.href;

                    const link_target =
                      contentSelectedType?.[`1_link_${contentPosition}_${next}`]
                        ?.content?.props?.children?.props?.target;
            ...
            {console.log("contentSelectedType", styleSelectedType)}
              ...
              >
                ...
                >
                  {[...new Array(leftColumnLength)].map((item, key) => {
                    ...
                    const link_style =
                      styleSelectedType[`2_link_left_${next}`];
                    const link_href =
                      contentSelectedType?.[`2_link_left_${next}`]?.content
                ...
                >
                  {[...new Array(rightColumnLength)].map((item, key) => {
                    ...
                    // BUTTON PROPS
                    const btn_compType =
                      contentSelectedType?.[`2_button_right_${next}`]?.content
                        ?.type;
                    const btn_children =
                      contentSelectedType?.[`2_button_right_${next}`]?.content
                        ?.props?.children;
                    ...
                    // TEXT PROPS
                    const txt_compType =
                      contentSelectedType?.[`2_text_right_${next}`]?.content
                        ?.type;
                    const txt_children =
                      contentSelectedType?.[`2_text_right_${next}`]?.content
                        ?.props?.children;
                    ...
                    // IMG PROPS
                    const img_alt =
                      contentSelectedType?.[`2_image_right_${next}`]?.content
                        ?.props?.alt;
                    const img_children =
                      contentSelectedType?.[`2_image_right_${next}`]?.content
                        ?.props?.src;
                    ...
                    // LINK PROPS
                    const link_children =
                      contentSelectedType?.[`2_link_right_${next}`]?.content
                        ?.props?.children?.props?.children;
                    const link_style =
                      contentSelectedType?.[`2_link_right_${next}`]?.content
